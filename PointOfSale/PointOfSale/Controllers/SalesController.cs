...
namespace PointOfSale.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        {
            ViewBag.sales = _saleService.GetSalesCount();
            ViewBag.products = _saleService.GetProductCount();
            return View();
        }
        ...
        {
            List<VMSale> vmListSales = _mapper.Map<List<VMSale>>(await _saleService.GetSalesCount());
            return StatusCode(StatusCodes.Status200OK, vmListSales);
        }
        ...
        {
            List<VMProduct> vmListProducts = _mapper.Map<List<VMProduct>>(await _saleService.GetProductCount());
            return StatusCode(StatusCodes.Status200OK, vmListProducts);
        }
