        ...
        "columns": [
            ...
            { "data": "price" },
            {
                "data": "isActive", render: function (data) {
                    if (data == 1)
                        return '<span class="badge badge-info badge-pill">Active</span>';
                    else
                        return '<span class="badge badge-danger rounded-pill">Inactive</span>';
                }
            },
            {
    ...
    if (model.idProduct == 0) {
        ...
        fetch("/Inventory/EditProduct", {
            ...
            if (responseJson.state) {
                ...
                rowSelected = null;
                $("#modalData").modal("hide");
                swal("Successful!", "Product Updated", "success");
